<section class="main-body">
    <!-- Список постов -->
    <h3 class="main-body__title">Все Туры</h3>

    <?php foreach ($data as $key => $value): ?>
        <div class="section-news__item">
            <img src="../../../public/img/tour/<?php echo explode(" ",$value['img'])[0] ?>" class="section-news__logo">
            ...
            <?php endif; ?>
            <a href="/admin/tourSetting/<?php echo $value['id']; ?>" class="section-news__btn-read btn">Редактировать</a>
        </div>
    <?php endforeach; ?>
</section>